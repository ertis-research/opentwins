...
As explained in the concept of [Child twin](/opentwins/docs/examples/docs/overeview/definition/concepts), we will create a child twin called robotic_arm_1 with the following structure, using the existing type that we created in the previous step:
