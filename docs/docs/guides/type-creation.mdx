...
<TabItem value="ui">
```
As explained in [TWINS WIP](www.google.com), OpenTwins has two types of DT schemas. One for creating a single DT and other for creating a type to create multiple instances of a DT.
...
- [Policy](www.google.com) (required): We must select a policy.
- Name.
- Description.
