...
<TabItem value="ui">
```
As explained in the [Quickstart](../../quickstart), OpenTwins has two types of DT schemas. One for creating a single DT and other for creating a type to create multiple instances of a DT.
